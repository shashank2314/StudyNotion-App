...
export const FooterLink3 = [
  {
    title:"Resourse",
    links:[
      {title:"Articles",link:"/Resourse/Articles"},
      {title:"Blog",link:"/Resourse/Blog"},
      {title:"Chart Sheet",link:"/Resourse/Chart-Sheet"},
      {title:"Code challenges",link:"/Resourse/Code-challenges"},
      {title:"Docs",link:"/Resourse/Docs"},
      {title:"Projects",link:"/Resourse/Projects"},
      {title:"Videos",link:"/Resourse/Videos"},
      {title:"Workspaces",link:"/Resourse/Workspaces"},
    ],
  },
  {
    title:"Support",
    links:[
      {title:"Help Center",link:"/Resourse/Help-Center"},
    ],
  },
];
...
export const FooterLink4 = [
  {
    title:"Plans",
    links:[
      {title:"Paid memberships",link:"/Resourse/Paid memberships"},
      {title:"For students",link:"/Resourse/For students"},
      {title:"Business solutions",link:"/Resourse/Business solutions"},
    ],
  },
  {
    title:"Community",
    links:[
      {title:"Forums",link:"/Resourse/Forums"},
      {title:"Chapter",link:"/Resourse/Chapter"},
      {title:"Events",link:"/Resourse/Events"},
    ],
  },
]